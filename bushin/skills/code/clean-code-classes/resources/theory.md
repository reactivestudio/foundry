...
Full reasoning behind each principle in `../SKILL.md`. Read this when you want the WHY. For concrete patterns, see `practices.md`. For SOLID at principle scope, see `code/solid/`.
