...
- Схемы системы в `roadmap/diagrams/` (5 самодостаточных SVG: карта
  приложений и вызовов, цепочка запуска стадии, конвейер change,
  хранилище и доступ, цикл самоулучшения) — встроены в components.md,
  рендерятся на GitHub.
